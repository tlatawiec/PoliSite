  ...
  return (
    <main className='flex h-screen flex-col items-center justify-between p-24'>
      <div className='bento-container'>
          <div className='bento-half'>
            ...
            <div className='bento-big flex flex-col'>
              <div className='flex justify-center'>
                <button className='main-button'>API Docs</button>
                <button className='main-button'>Code Samples</button>
              </div>
          ...
          <div className='bento-half'>
            <div className='bento-big pl-10 py-10 bg-pb rounded-lg'> 
              ...
              <span className='text-white'>&#123;</span> <br />
                ...
                &nbsp; &nbsp; <span className='text-red'>' Publish Date: '</span> <span classNmae='text-white'> : </span> <span className='text-blue'>' 2023-06-07 ',</span><br />
